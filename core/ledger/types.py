...
ENTRYPOINTS = frozenset({ENTRYPOINT_V06, ENTRYPOINT_V07, ENTRYPOINT_V08})
...
ACCOUNT_KINDS = frozenset({KIND_EOA, KIND_EOA_7702, KIND_WALLET_4337})
WALLET_KINDS = ACCOUNT_KINDS | {KIND_CONTRACT_UNKNOWN}
